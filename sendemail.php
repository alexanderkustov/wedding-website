...
if( isset($_POST['rsvp_submit']) ){
	...
	$gname = filter_var($_POST['guest_name'], FILTER_SANITIZE_STRING);
	...
	$dietaryreq = filter_var($_POST['dietaryreq'], FILTER_SANITIZE_STRING);

	// recipients
	$to  = 'dan@appyparking.com';
	...
	<body>
	  ...
	  <p>
		...
		<strong>Name of Guest:</strong> '.$gname.'<br>
		<strong>Dietary requests:</strong> '.$dietaryreq.'
	  </p>
	</body>
	</html>
	';
